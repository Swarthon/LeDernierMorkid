@property( !hlms_shadowcaster && TERRAIN_enabled )
...
@piece( custom_vs_posExecution )
    float3 terraShadowData = terrainShadows.SampleLevel( terrainShadowSampler, worldPos.xz * passBuf.invTerrainBounds.xz + passBuf.terraOrigin.xz, 0 ).xyz;
    float terraHeightWeight = worldPos.y * passBuf.invTerrainBounds.y + passBuf.terraOrigin.y;
