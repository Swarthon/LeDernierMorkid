...
typedef struct SDL_MouseWheelEvent {
	...
	Ogre::uint32 windowID;  /**< The window with mouse focus, if any */
	Ogre::uint32 which;     /**< The mouse instance id, or SDL_TOUCH_MOUSEID */
	Ogre::int32  x;         /**< The amount scrolled horizontally, positive to the right and negative to
	                   the left */
	Ogre::int32  y;         /**< The amount scrolled vertically, positive away from the user and negative
	                  toward the user */
	Ogre::uint32 direction; /**< Set to one of the SDL_MOUSEWHEEL_* defines. When FLIPPED the
	                           values in X and Y will be opposite. Multiply by -1 to change them
	                           back */
} SDL_MouseWheelEvent;
