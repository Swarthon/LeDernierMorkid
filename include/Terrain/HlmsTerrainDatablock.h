...
public:
	HlmsTerrainDatablock(Ogre::IdString              name,
	                     HlmsTerrain*                creator,
	...
	void setTexture(TerrainTextureTypes           texType,
	                Ogre::uint16                  arrayIndex,
	                const Ogre::TexturePtr&       newTexture,
	                const Ogre::HlmsSamplerblock* refParams = 0);

	Ogre::TexturePtr getTexture(TerrainTextureTypes texType) const;
	Ogre::TexturePtr getTexture(size_t texType) const;

	Ogre::uint16 _getTextureIdx(TerrainTextureTypes texType) const {
	...
	static Ogre::HlmsTextureManager::TextureMapType
	suggestMapTypeBasedOnTextureType(TerrainTextureTypes type);
