...
void GraphicsGameState::createScene(void) {
	...
	texLocation = hlmsTextureManager->createOrRetrieveTexture(
	        "terrain_texture.jpg", Ogre::HlmsTextureManager::TEXTURE_TYPE_ENV_MAP);
	...
	texLocation = hlmsTextureManager->createOrRetrieveTexture(
	        "grass_green-01_diffusespecular.dds", Ogre::HlmsTextureManager::TEXTURE_TYPE_ENV_MAP);
	...
	texLocation = hlmsTextureManager->createOrRetrieveTexture(
	        "terr_rock-dirt.jpg", Ogre::HlmsTextureManager::TEXTURE_TYPE_ENV_MAP);
	...
	texLocation = hlmsTextureManager->createOrRetrieveTexture(
	        "terr_dirt-grass.jpg", Ogre::HlmsTextureManager::TEXTURE_TYPE_ENV_MAP);
