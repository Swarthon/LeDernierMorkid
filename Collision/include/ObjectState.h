...
namespace Collision {
	...
	public:
		 ...
		 * @param gameEntity
		 *	the Common::GameEntity to synchronize
		 * @param logicSystem
		 *	the LogicSystem to which belongs the gameEntity, used to get the transform of the Common::GameEntity
		 */
		 ...
		 * @param worldTrans
		 *	the btTransform to define with the internal btTransform
		 * @remarks
		 ...
		 * Method to get the btTransform of the Object
		 * @param worldTrans
		 *	the btTransform used to set the internal btTransform
		 * @remarks
		 *	This method is used internaly by Bullet. Do not use it
		 */
