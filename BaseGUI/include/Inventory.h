...
private:
	...
	// Private methodes
	void createLeftBarButton(std::string name, std::string text, Morkidios::Object::Type t);
	void createObjectButton(std::string name, Morkidios::Object* o, CEGUI::Window* parent);
	...
	void clear();
	void refresh(Morkidios::Object::Type t);
};
